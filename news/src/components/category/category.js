...
function Category() {
    ...
    async function fetch() {
        try {
            ...
            const response2 = await axios.post(`https://localhost:7125/PaginationCotroller/paginationBlogsByCategory?id=${state.id}&limit=${limit}`)
...
//             }
//             if (subcategory == undefined) {
//                 html = await fetchHTML('https://vietnamnet.vn/' + category);
...
//                                        data-utm-source="#vnn_source=thethaoeuro&amp;vnn_medium=menu-top">{item.content}</a>
//                                 </li>
//                             ))}
//                         </ul>
//
...
//             </div>
//             <div
//                 className={` ${styles.container}  ${styles.sectionTopstory}  ${styles.normal - category}  ${'pb-0'}  ${'align-start'}  `}>
//                 <div className={styles['container__left']}>
//                     {topStory && <div
//                         className={` ${styles.verticalPost} ${styles.verticalPost} ${styles['topStory-1nd']} ${styles['version-news']} ${'mb-20'} `}>
//                         <div className={styles['verticalPost__avt']}>
//                             <a href={"/detail" + topStory.url}
//                                data-utm-source="#vnn_source=bongdavietnam&amp;vnn_medium=tiemdiem1">
//                                 <picture>
...
//                             <h2 className={`${styles['verticalPost__main-title']} ${styles['vnn-title']}`}
//                                 data-id="2292526" ispr="False">
//                                 <a href={"/detail" + topStory.url} title={topStory.title}
//                                    data-utm-source="#vnn_source=bongdavietnam&amp;vnn_medium=tiemdiem1" data-limit="">
//                                     {topStory.title}
//                                 </a>
//                             </h2>
...
//                                            data-utm-source="#vnn_source=bongdavietnam&amp;vnn_medium=tiemdiem2">
//                                             <picture>
...
//                                     <div className={styles['verticalPost__main']}>
//
//                                         <h3 className={styles['verticalPost__main-title']} data-id="2292167"
//                                             ispr="False">
