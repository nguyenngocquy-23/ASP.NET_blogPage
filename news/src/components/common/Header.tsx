        ...
        <header className={styles.header}>
            <div className={styles.container}>
                    ...
                    <ul>
                        ...
                        {currentUser ? (
                            <li className={styles.account}>
                                ...
                                <div className={styles.logout}><Link to="/login" onClick={handleLogout}>Đăng xuất</Link></div>
                            </li>
                        ) : (
                ...
                <div className={styles.search}>
                    <form className={styles.formSearch} action="/searchPage/timkiem" method="get">
